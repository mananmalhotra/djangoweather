...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=CD3C4EBC-546C-4F30-9FD9-51D7BB6BB722")
		try :
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=CD3C4EBC-546C-4F30-9FD9-51D7BB6BB722")
		try :
			api = json.loads(api_request.content)
		except Exception as e:
			api = "Error..."
